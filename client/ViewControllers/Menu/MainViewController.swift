...
//        view.addGestureRecognizer(tapGestureRecognizer)
        ...
        showViewController(viewController: BaseNavigationController.self, storyboardId: "ContainerViewNavID")
    }
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Home
            self.showViewController(viewController: UINavigationController.self, storyboardId: "ContainerViewNavID")
        case 1:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "ProfileVCNavID")
        case 2:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "NotificationViewControllerNavID")
        case 3:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "SettingsVCNavID")
        case 4:
            sideMenuViewController.doSignOut()
        default:
            break
        }
