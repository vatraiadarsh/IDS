...
@IBDesignable public class PulseButton: UIControl {
    ...
    @IBInspectable public var title : String? {
        didSet { button.setTitle(title, for: UIControl.State.normal) }
    }

    public var font : UIFont? {
        didSet { button.titleLabel?.font = font }
    }
    ...
    private func setup() {
        ...
        for target in allTargets {
            let actions = actions(forTarget: target, forControlEvent: UIControl.Event.touchUpInside)
